 ...
 */
public class Fragment_Bag extends Fragment {
    ...
    public Fragment_Bag(LiquidSwipeClipPathProvider liquidSwipeClipPathProvider) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment__bag, container, false);
